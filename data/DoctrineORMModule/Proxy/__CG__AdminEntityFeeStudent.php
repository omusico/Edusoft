 ...
 */
class FeeStudent extends \Admin\Entity\FeeStudent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'session', 'student', 'payments', 'studentTotal');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FeeStudent $proxy) {
    ...
    public function setPayments()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPayments', array());

        return parent::setPayments();
    }
