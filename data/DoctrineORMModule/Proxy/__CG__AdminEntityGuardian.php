 ...
 */
class Guardian extends \Admin\Entity\Guardian implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'user', 'fname', 'lname', 'mname', 'gender', 'mobile1', 'mobile2', 'email', 'occupation', 'person');
        }
     ...
     * {@inheritDoc}
     */
    public function addPerson(\Doctrine\Common\Collections\Collection $person)
    {
     ...
     * {@inheritDoc}
     */
    public function removePerson(\Doctrine\Common\Collections\Collection $person)
    {
