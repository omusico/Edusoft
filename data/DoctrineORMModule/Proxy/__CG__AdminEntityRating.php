 ...
 */
class Rating extends \Admin\Entity\Rating implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'rate', 'traits', 'student', 'session');
        }
     ...
     * {@inheritDoc}
     */
    public function setTraits(\Admin\Entity\Traits $traits)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTraits', array($traits));

        return parent::setTraits($traits);
    }
