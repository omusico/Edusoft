<?php
namespace EduUser\Listener;

use Zend\EventManager\AbstractListenerAggregate;
use Zend\EventManager\EventManagerInterface;
use Zend\EventManager\Event;

class EduUserListener extends AbstractListenerAggregate
{
    ...
    public function onRegister(Event $e)
    {
        ...
        $defaultUserRole = $em->getRepository('EduUser\Entity\Role')->findOneBy($criteria);
